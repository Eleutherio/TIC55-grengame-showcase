...
export default function RecuperarSenha() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate(`/nova-senha?email=${encodeURIComponent(normalizedEmail)}`, {
    ...
    <div className="recoverPage">
      <div className="recoverContainer">
        ...
        <p className="description">
          Informe o seu e-mail corporativo cadastrado. Um código de validação será enviado
          para você recuperar a sua senha. Caso não receba o e-mail, verifique sua caixa de
          spam ou entre em contato com o seu administrador.
        </p>

        <form onSubmit={handleSubmit}>
          <label className="inputLabel" htmlFor="recover-email">
